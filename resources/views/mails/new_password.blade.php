    ...
    <table cellpadding="0" cellspacing="0" width="100%"
        ...
        <tr>
            <td style="padding: 40px; color: #374151; line-height: 1.6;">
                <h1 style="font-size: 24px; color: #1a1a1a; margin-bottom: 20px;">Xin chào quý khách,{{ $email }}
                </h1>
                ...
                <div
                    ...
                    <span style="font-size: 12px; color: #6b7280; text-transform: uppercase; letter-spacing: 2px;">Mật khẩu mới của bạn</span>
                    <div
