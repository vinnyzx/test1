...
<head>
    ...
    <title>Sửa thương hiệu - Bee Phone Admin</title>
        ...
        <main class="flex-1 ml-64">
            ...
            <div class="p-8 space-y-6">
                <div class="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-100 dark:border-slate-800 shadow-sm">
                    <div class="flex flex-wrap justify-between items-end gap-4">
                        <div class="flex flex-col gap-1">
                            <p class="text-slate-900 dark:text-white text-4xl leading-tight font-bold">Sửa thương hiệu</p>
                            <p class="text-slate-500 text-sm">Cập nhật thông tin và trạng thái hiển thị của thương hiệu.</p>
                        </div>
                ...
                <div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden">
                    ...
                    <form action="{{ route('admin.brands.update', $brand) }}" method="POST" class="p-6">
                        @csrf
                        @method('PUT')
