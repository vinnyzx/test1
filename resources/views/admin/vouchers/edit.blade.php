                        ...
                        <section class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div class="flex flex-col gap-2">
                                    ...
                                    <input class="border-[#e6e3db] rounded-lg focus:ring-primary focus:border-primary"
                                        type="number" value="{{ old('points_required', $voucher->points_required) }}"
                                        ...
                                        <select name="categories[]" id="categories" class="select2-multiple w-full"
                                            ...
                                            @foreach ($categories as $category)
                                                <option value="{{ $category->id }}"
                                                    {{ in_array($category->id, old('categories', $voucher->categories->pluck('id')->toArray())) ? 'selected' : '' }}>
                                                    {{ $category->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        ...
                                        <select name="products[]" id="products" class="select2-multiple w-full"
                                            ...
                                            @foreach ($products as $product)
                                                <option value="{{ $product->id }}"
                                                    {{ in_array($product->id, old('products', $voucher->products->pluck('id')->toArray())) ? 'selected' : '' }}>
                                                    {{ $product->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        ...
                                        <select name="brands[]" id="brands" class="select2-multiple w-full"
                                            ...
                                            @foreach ($brands as $brand)
                                                <option value="{{ $brand->id }}"
                                                    {{ in_array($brand->id, old('brands', $voucher->brands->pluck('id')->toArray())) ? 'selected' : '' }}>
                                                    {{ $brand->name }}
                                                </option>
                                            @endforeach
                                        </select>
