            ...
            <div class="">
                ...
                <main class="flex-1 flex flex-col">
                    ...
                    <div class="p-8 w-full">
                        ...
                        <div class="mb-8">
                            <h1 class="text-3xl font-extrabold text-slate-900 dark:text-white mb-2">Thêm Danh mục Mới</h1>
                            <p class="text-slate-500 dark:text-slate-400">Tạo danh mục mới để phân loại các bài viết tin tức
                                trên hệ thống Bee Phone.</p>
                        </div>
                        <!-- Form Card -->
                        <div
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-5">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <input
                                            ...
                                            placeholder="Nhập tên danh mục (ví dụ: Đánh giá điện thoại)">
                                    </div>
                                    <!-- Parent Category -->
                                    <div class="space-y-2">
                                        ...
                                        <input
                                            ...
                                            disabled="" placeholder="danh-muc-tu-dong" type="text" value="" />
                                    </div>
                                </div>
