        ...
        <section class="px-4 md:px-10 lg:px-20 mt-16">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <div
                    ...
                    <div class="relative rounded-lg overflow-hidden aspect-square bg-gray-100 mb-4">
                        <div class="w-full h-full bg-cover bg-center group-hover:scale-110 transition-transform duration-500"
                            style="background-image: url('https://lh3.googleusercontent.com/aida-public/AB6AXuD1_JxYdx1cq1BEyFxzaXaOyJkvTGP8lSXRlkR-nFhSDDm8Ah7hVpB3MrrXCE5mG84_w56V09VN3_C4hM346MIIu-Hp_UYEStsSfqFYT8mMbyWrKV4cggBF9xmQuHsYa7LmbqkmUGtWl4Jdk88gNRANP8LGcgDRNDL2AAt3TBaxfHXpEJPaJuv8HqriO4__ZcQoWwxylSmUtW4928GChNJ4IwzMNWCx-oq0u3wsSd71F2l8ni2HUMX9zz_fRldNqsBYkQ9nnrAcKcA');">
                        </div>
                        <span
                            class="absolute top-2 left-2 bg-green-500 text-white text-[10px] font-bold px-2 py-1 rounded uppercase">MỚI</span>
                    </div>
                    <h3 class="font-bold text-lg mb-1">Pixel 8 Pro</h3>
                    <p class="text-gray-500 dark:text-gray-400 text-sm mb-4">Điện thoại thông minh nhất từ Google.</p>
                    <div class="flex items-center justify-between">
                        <span class="text-xl font-bold">22.990.000₫</span>
                        <button
                ...
                <div
                    ...
                    <div class="relative rounded-lg overflow-hidden aspect-square bg-gray-100 mb-4">
                        <div class="w-full h-full bg-cover bg-center group-hover:scale-110 transition-transform duration-500"
                            style="background-image: url('https://lh3.googleusercontent.com/aida-public/AB6AXuBA8fmwzNRLE35gdkxM7uOrUZakQT9UInq0ai_Xx2FskL3tQGl0efzXS_pDGQiz-nQAlooacIn681behLhvcUvRt4APi-Hw2eEa3o7QY5_6GOoS1ZhtdeRaejlblS_Se4EqhvwKFtzbECEM6vSKdnBA7VQfGZhtlX0reQagbSo93lPGyiZvrCq_flN9os6F3TOz5Ra8iwFyhzwKuPGwQ_gW-weP58-BHjHabVy8uRniGoS-9Vr6WHHU5ZYY6OfHy-ks4WLy-fSL4pY');">
                        </div>
                    </div>
                    <h3 class="font-bold text-lg mb-1">Samsung S24 Ultra</h3>
                    <p class="text-gray-500 dark:text-gray-400 text-sm mb-4">Đỉnh cao quyền năng AI.</p>
                    <div class="flex items-center justify-between">
                        <span class="text-xl font-bold">29.990.000₫</span>
                        <button
                            class="bg-black dark:bg-primary text-white dark:text-black w-10 h-10 rounded-lg flex items-center justify-center hover:bg-primary hover:text-black transition-colors">
                            <span class="material-symbols-outlined">add_shopping_cart</span>
                        </button>
                ...
                <div
                    ...
                    <div class="relative rounded-lg overflow-hidden aspect-square bg-gray-100 mb-4">
                        <div class="w-full h-full bg-cover bg-center group-hover:scale-110 transition-transform duration-500"
                            style="background-image: url('https://lh3.googleusercontent.com/aida-public/AB6AXuD9x0MWzk-kM4uSZvTuGEff6q312ynd9VroQ4o97R57xgoPyzlfIrCG214LbPNkzAT9klVZGaMC_OYN0XK7iEdvrCT0TLOj2jOdWSgLwa-1V6fm-W-vv3Q9FZDlXf-38x55sGEO9TTcH1paTig7jeSLXLTb5mOUYqFpGIJwJt-yMqAHEE7aRNPA_tqiyzIIoJdM_UVe_HL1xk3swqM4Iw9q9vsw6dI8M4HddE_CAI9GOKZkUnzzpOykryhClxHU2TkZy9mPQCbj2uE');">
                        </div>
                        <span
                            class="absolute top-2 left-2 bg-green-500 text-white text-[10px] font-bold px-2 py-1 rounded uppercase">MỚI</span>
                    </div>
                    <h3 class="font-bold text-lg mb-1">Bee Buds Pro</h3>
                    <p class="text-gray-500 dark:text-gray-400 text-sm mb-4">Âm thanh không gian cực đỉnh.</p>
                    <div class="flex items-center justify-between">
                        <span class="text-xl font-bold">4.990.000₫</span>
                        <button
                            class="bg-black dark:bg-primary text-white dark:text-black w-10 h-10 rounded-lg flex items-center justify-center hover:bg-primary hover:text-black transition-colors">
                            <span class="material-symbols-outlined">add_shopping_cart</span>
                        </button>
                ...
                <div
                    ...
                    <div class="relative rounded-lg overflow-hidden aspect-square bg-gray-100 mb-4">
                        <div class="w-full h-full bg-cover bg-center group-hover:scale-110 transition-transform duration-500"
                            style="background-image: url('https://lh3.googleusercontent.com/aida-public/AB6AXuAncWEokfHuik2Ir3lhITCkq1ufNlCPoKPOqQt1R3Ts0O5CGUWQGRt2EZQ30vp3HwT-TYzUNUKmwACT5ZeSpBwcC-MXtdueOiLoo2hdl6zbnWIwrifqx_G8E3JG6ivXqShoKZvaGfrV2bmGKl0-g3BSyOtxshckPksxd5oRn8-eKC4jeDe3GtgeKylrQlVYRtCUtmqL2VHhulG6A2V5xi5IYX2vKlPC_LrMQ4Nrp-WeFGF3A-fBzk7QtRmCP5-lEWoU_LYA_paHQXg');">
                        </div>
                    </div>
                    <h3 class="font-bold text-lg mb-1">Bee Watch Ultra</h3>
                    <p class="text-gray-500 dark:text-gray-400 text-sm mb-4">Bền bỉ. Mạnh mẽ. Đẳng cấp.</p>
                    <div class="flex items-center justify-between">
                        <span class="text-xl font-bold">9.990.000₫</span>
                        <button
                            class="bg-black dark:bg-primary text-white dark:text-black w-10 h-10 rounded-lg flex items-center justify-center hover:bg-primary hover:text-black transition-colors">
                            <span class="material-symbols-outlined">add_shopping_cart</span>
                        </button>
